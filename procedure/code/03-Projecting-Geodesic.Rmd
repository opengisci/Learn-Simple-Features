...
watersheds_NAD83 <- watersheds_NAD83 |>  mutate(
  ...
  spherical_perim = st_perimeter(geom)
)
...
watersheds_NAD83 <- watersheds_NAD83 |>  mutate(
  ...
  ellipsoidal_perim = st_perimeter(geom)
)
...
watersheds_measure <- watersheds |> 
  mutate(planar_area = st_area(geom),
         planar_perim = st_perimeter(geom),
         ellipsoidal_area = st_area(st_transform(geom, 4269)),
         ellipsoidal_perim = st_perimeter(st_transform(geom, 4269)))
